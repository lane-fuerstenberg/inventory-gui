...
/**
 * Controller for fxml partTableView
 */
public class PartTableViewController implements Initializable {
    ...
    /**
     * Observable list of parts stored in tableview
     */
    private ObservableList<Part> parts;

    /**
     * Assigns search bar for this partTableView
     * @param searchBar the TextField to be used as a searchbar
     */
    public void setSearchBar(TextField searchBar) {
        ...
        partTableView.setItems(filteredData);
    }
