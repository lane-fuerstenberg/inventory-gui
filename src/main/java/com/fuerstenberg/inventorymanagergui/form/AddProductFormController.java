...
/**
 * Controller for fxml addProductForm
 */
public class AddProductFormController implements Initializable {
    ...
    /**
     * List of associated parts for the current product being created that is displayed to user via tableview
     */
    private ObservableList<Part> associatedParts;


    /**
     * Remove selected associated part from tableview, called when button is selected
     */
    @FXML
    ...
    /**
     * Saves the data as a product to inventory
     */
    @FXML
    ...
    /**
     * Adds selected part from partTableView to associatedParts list
     */
    @FXML
    public void addPart() {
    ...
    /**
     * @param inventory inventory amount
    ...
    /**
     * Closes stage when cancelButton is interacted with
     */
